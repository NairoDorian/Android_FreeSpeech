...
```
       16 kHz Microphone / Audio Stream (CPAL / AAudio)
                           │
                           ▼
...
```
*Impact*: Any Android keyboard using the standard speech recognizer API (SwiftKey, Gboard, Samsung Keyboard) immediately displays live streaming dictation without waiting for end-of-utterance.
